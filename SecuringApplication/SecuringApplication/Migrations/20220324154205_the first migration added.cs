...
{
    public partial class thefirstmigrationadded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorRegistrationModels", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "PatienntRegistrationModels",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatienntRegistrationModels", x => x.Id);
                });
